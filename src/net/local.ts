...
export function initLocal(seedWords: string[], themes: Theme[], game: Game, fingerStatements: string[]): void {
  state = initialState(Math.floor(Math.random() * 1e9), seedWords, themes, game, fingerStatements)
