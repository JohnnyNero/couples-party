...
export function ScreenLikelyRound({ s }: { s: SessionState }) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto text-center">
      <div className="text-[0.7rem] sm:text-sm uppercase tracking-[0.22em] font-extrabold text-fg/50 mb-3 sm:mb-5">
        Who's more likely to
      </div>
      <div className="text-2xl sm:text-5xl font-display font-extrabold leading-tight break-words">
        {round.statement}?
      </div>
